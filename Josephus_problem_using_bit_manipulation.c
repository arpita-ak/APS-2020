//Program for Josephus problem of bit manipulation killing alternate people and returning the last person who survives.
...
int main()
{
    ...
    scanf("%d",&n);
    printf("\nThe person who survives is: %d",josephify(n));
    return 0;
}
